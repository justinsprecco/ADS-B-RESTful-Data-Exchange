...
describe("POST /users/:id/devices", () =>
{
   ...
   {
      Device.create.mockResolvedValue({ _id: 1, userId: 1, macAddress: "00:14:22:01:23:45", latitude: 25, longitude: 10 })

      const res = await request(app)
         .post("/users/1/devices")
         .send({ macAddress: "00:14:22:01:23:45", latitude: 25, longitude: 10 })
   ...
   it("should return an error if adding device fails", async () =>
   {
      ...
      const res = await request(app)
         .post("/users/1/devices")
         .send({ userId: 8, macAddress: "00:14:22:01:23:45", latitude: 25, longitude: 10 })
